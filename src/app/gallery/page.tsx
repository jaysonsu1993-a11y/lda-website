  ...
  return (
    <main className="min-h-screen bg-[#131212] text-white w-full">
      ...
      <nav className="flex items-center justify-between px-4 md:px-12 py-4 border-b border-[#333] w-full">
        ...
        <Link href="/gallery" className="text-sm uppercase tracking-widest text-gray-400">
          GALLERY
        </Link>
      </nav>
      ...
      <section className="px-4 md:px-12 py-16 md:py-24">
        ...
        <p className="text-gray-400 text-center max-w-2xl mx-auto">
          Artist setups, product photography, and moments from the LdA community.
        </p>
      </section>
      ...
      <section className="px-4 md:px-12 pb-16 md:pb-24">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
          {filteredItems.map((item) => (
            <div 
              key={item.id}
              className="aspect-square bg-[#1a1a1a] border border-[#333] hover:border-gray-600 transition-colors cursor-pointer group relative overflow-hidden"
            >
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center p-4 text-center">
                <span className="text-xs text-gray-600 uppercase tracking-widest mb-2">
                  {item.category}
                </span>
      ...
      <section className="px-4 md:px-12 py-16 bg-[#1a1a1a] border-y border-[#333]">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">SHARE YOUR SETUP</h2>
          <p className="text-gray-400 mb-6">
            Got a photo of your LdA gear? Submit it for a chance to be featured.
          </p>
