...
const articles = [
  {
    id: "midi-basics",
    title: "MIDI Basics",
    excerpt: "Understanding MIDI: What it is and how it works",
    category: "Fundamentals",
    date: "2025-01-15"
  },
  {
    id: "program-change",
    title: "Program Change Messages",
    excerpt: "How to use program change to switch presets instantly",
    category: "Tutorial",
    date: "2025-01-20"
  },
  {
    id: "cc-messages",
    title: "Control Change Deep Dive",
    excerpt: "Mastering CC messages for expression and control",
    category: "Advanced",
    date: "2025-02-01"
  },
  {
    id: "midi-routing",
    title: "MIDI Routing Strategies",
    excerpt: "Best practices for chaining multiple devices",
    category: "Setup",
    date: "2025-02-10"
  },
  {
    id: "sync-tempo",
    title: "Tempo Sync & Clock",
    excerpt: "Keeping all your devices in perfect time",
    category: "Tutorial",
    date: "2025-02-15"
  },
  {
    id: "midi-merging",
    title: "MIDI Merging & Splitting",
    excerpt: "Combine multiple controllers into one signal",
    category: "Advanced",
    date: "2025-02-20"
  }
];
  ...
  return (
    <main className="min-h-screen bg-[#131212] text-white w-full">
      ...
      <nav className="flex items-center justify-between px-4 md:px-12 py-4 border-b border-[#333] w-full">
        ...
        <Link href="/lab" className="text-sm uppercase tracking-widest text-gray-400">
          LAB
        </Link>
      </nav>
      ...
      <section className="px-4 md:px-12 py-16 md:py-24">
        ...
        <p className="text-gray-400 text-center max-w-2xl mx-auto">
          Deep dives into MIDI technology, tutorials, and insights from the world of effect controllers.
        </p>
      </section>
      ...
      <section className="px-4 md:px-12 pb-16 md:pb-24">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {articles.map((article) => (
            <article 
              key={article.id}
              className="bg-[#1a1a1a] border border-[#333] hover:border-gray-600 transition-colors cursor-pointer group"
            >
