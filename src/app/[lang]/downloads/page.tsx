  ...
  return (
    <main className="min-h-screen bg-[#131212] text-white w-full">
      ...
      <section className="px-4 md:px-12 py-16 md:py-24">
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-center mb-4">{t.downloads.hero.title}</h1>
        <p className="text-gray-400 text-center max-w-2xl mx-auto">{t.downloads.hero.subtitle}</p>
      </section>
          ...
          <div key={sectionIndex} className="mb-12">
            ...
            <div className="space-y-2">
              {section.files.map((file, fileIndex) => (
                <div key={fileIndex} className="bg-[#1a1a1a] border border-[#333] hover:border-gray-600 transition-colors p-4 flex items-center justify-between">
